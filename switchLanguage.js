document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        en: {
            ...
            projectmovie: "Introduction to React with a movie searcher app using an api",
            projecttodo: "Todo app with React",
            nombre: "Name",
        ...
        es: {
            ...
            projectmovie: "Introducción a React con una app para buscar películas utilizando una api",
            projecttodo: "App de lista de tareas con React",
            nombre: "Nombre",
